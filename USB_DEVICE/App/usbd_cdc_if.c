...
/* USER CODE BEGIN PV */
/* Private variables ---------------------------------------------------------*/
uint8_t lineCodingBuff[7] = {0x00, 0xC2, 0x01, 0x00, 0x00, 0x00, 0x08};
...
USBD_CDC_LineCodingTypeDef LineCoding_t =
{
  115200,
  0,
  0,
...
static int8_t CDC_Control_FS(uint8_t cmd, uint8_t* pbuf, uint16_t length)
{
  ...
  /*******************************************************************************/
    case CDC_SET_LINE_CODING:
			LineCoding_t.bitrate = (uint32_t)(pbuf[0] | (pbuf[1] << 8) | (pbuf[2] << 16) | (pbuf[3] << 24));
...
//			}
    ...
    case CDC_GET_LINE_CODING:
			pbuf[0] = (uint8_t)(LineCoding_t.bitrate);
			pbuf[1] = (uint8_t)(LineCoding_t.bitrate >> 8);
			pbuf[2] = (uint8_t)(LineCoding_t.bitrate >> 16);
			pbuf[3] = (uint8_t)(LineCoding_t.bitrate >> 24);
